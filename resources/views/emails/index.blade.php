                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            <tr>
                                <td align="left" bgcolor="#ffffff"
                                    ...
                                    <p style="margin: 0;">Tap the button below to confirm your email address. If you
                                        didn't create
                                        an account with <a href="https://localhost">Our Website</a>, you can safely
                                        delete this
                                        email.</p>
                                </td>
                            </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td align="center" bgcolor="#1a82e2"
                                                            ...
                                                            <a href="{{ config('constants.APP_FE_URL') }}/confirm-account?confirm-token={{ $data }}"
                                                               target="_blank"
                            ...
                            <tr>
                                <td align="left" bgcolor="#ffffff"
                                    ...
                                    <p style="margin: 0;">If that doesn't work, copy and paste the following link in
                                        your
                                        browser:</p>
                                    <p style="margin: 0;"><a href="https://localhost" target="_blank">https://api.com/xxx-xxx-xxxx</a>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="left" bgcolor="#ffffff"
                                    ...
                                    <p style="margin: 0;">Cheers,<br> Cloud</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td align="center" bgcolor="#e9ecef"
                                    ...
                                    <p style="margin: 0;">You received this email because we received a request for
                                        [type_of_action]
                                        for your account. If you didn't request [type_of_action] you can safely delete
                                        this
                                        email.</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" bgcolor="#e9ecef"
                                    ...
                                    <p style="margin: 0;">To stop receiving these emails, you can <a
                                            href="https://localhost" target="_blank">unsubscribe</a> at any
                                        time.</p>
